...
const lineContentList: ReadonlyArray<HistoryContent> = [
  { body: 'バックエンド開発', href: null },
]

const yahooContentList: ReadonlyArray<HistoryContent> = [
  { body: 'ヤフーショッピング 商品レビュー バックエンド開発', href: null },
]

const ouContentList: ReadonlyArray<HistoryContent> = [
  {
...
export const histories: ReadonlyArray<History> = [
  { yearFrom: '2021', yearTo: '20xx', body: 'LINE Software Engineer', contents: lineContentList },
  { yearFrom: '2019', yearTo: '2021', body: 'Yahoo! Japan Software Engineer', contents: yahooContentList },
  { yearFrom: '2017', yearTo: '2019', body: '大阪大学大学院　基礎工学研究科', contents: ouContentList },
